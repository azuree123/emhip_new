...
namespace Emhip.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819184003_AddCountryOfOriginAndDemographicFilters")]
    partial class AddCountryOfOriginAndDemographicFilters
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Emhip.Domain.Entities.GuestDemographics", b =>
                {
                    ...
                    b.HasIndex("CountryOfOrigin")
                        .HasDatabaseName("IX_GuestDemographics_CountryOfOrigin");

                    b.HasIndex("Ethnicity")
                        .HasDatabaseName("IX_GuestDemographics_Ethnicity");
